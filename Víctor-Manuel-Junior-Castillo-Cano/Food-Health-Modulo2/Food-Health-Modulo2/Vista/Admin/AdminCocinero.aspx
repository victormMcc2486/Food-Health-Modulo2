...
<body>
    ...
    <ul id="dropdown1" class="dropdown-content">
        <li><a href="AdminChef.aspx">Cocineros</a></li>
    </ul>
        ...
        <ul class="Left hide-on-med-and-down">
            ...
            <li class="fixed right ">
                ...
                <div class="fixed-action-btn vertical col-sm-5">
                    ...
                    <ul>
                        <li><a href="AdminChef.aspx" class="btn-floating btn tooltipped  red" data-position="left" data-delay="50" data-tooltip="Administrar Chef"><i class="material-icons">person_add</i></a></li>
                ...
                <div class="card-content">
                    <p>
                            <div style="margin-top: 40px;">
                                <center><h3>ADMINISTRAR COCINEROS</h3></center>
                            </div>
                            <div class="row">
                                <div class="col-sm-8">
