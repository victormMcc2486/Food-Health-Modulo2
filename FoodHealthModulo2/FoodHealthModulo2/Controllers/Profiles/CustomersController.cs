...
namespace FoodHealthModulo2.Controllers.Profiles
{
    public class CustomersController : Controller
    {
        ...
        {
            ViewBag.DocumentTypeId = new SelectList(db.DomentTypes, "DocumentTypeID", "NameDocument");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "CustomerId,DocumentTypeId,Document,FirstName,LastName,Phone,Address,Email")] Customer customer)
        {
            ...
            ViewBag.DocumentTypeId = new SelectList(db.DomentTypes, "DocumentTypeID", "NameDocument", customer.DocumentTypeId);
            return View(customer);
        }
