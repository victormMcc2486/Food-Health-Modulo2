<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminTipoAlimento.aspx.cs" Inherits="Vista.Chef.AdminTipoAlimento" %>
...
<head runat="server">
    ...
    <title>Administrar Tipo Alimentos</title>
</head>
<body>
                ...
                <div class="card-content">
                    <p>
                            <div style="margin-top: 40px;">
                                <center><h3>ADMINISTRAR TIPO ALIMENTOS</h3></center>
                            </div>
                            <div class="row">
                                <div class="col-sm-8">
                                    <div class="form-group">
