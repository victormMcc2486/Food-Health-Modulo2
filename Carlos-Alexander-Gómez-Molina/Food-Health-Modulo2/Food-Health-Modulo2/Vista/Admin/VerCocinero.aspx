...
<body>
    <form id="form1" runat="server">
                ...
                <table class="table table-active" style="margin-top: 30px;">
                    <tr>
                        ...
                        <asp:GridView ID="gvCocineros" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="gvCocineros_SelectedIndexChanged">
                            ...
                            <Columns>
                                <asp:ButtonField CommandName="Select" ControlStyle-CssClass="waves-effect waves-light btn btn-primary" HeaderText="Action" ShowHeader="True" Text="Ver" />
                            </Columns>
        ...
        <!-- Modal Structure -->
        <div class="modal" tabindex="-1" runat="server" id="modal1" role="dialog">
