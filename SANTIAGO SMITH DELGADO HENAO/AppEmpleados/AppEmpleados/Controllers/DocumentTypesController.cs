...
namespace AppEmpleados.Controllers
{
    public class DocumentTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DocumentTypeId,DocumentName")] DocumentType documentType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DocumentTypeId,DocumentName")] DocumentType documentType)
        {
            if (ModelState.IsValid)
            {
