...
namespace AppEmpleados.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeId,FirstName,LastName,Salary,DateOfBirth,Email,DocumentTypeId")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeId,FirstName,LastName,Salary,DateOfBirth,Email,DocumentTypeId")] Employee employee)
        {
            if (ModelState.IsValid)
            {
